...
public class GarageCollider : MonoBehaviour
{
    ...
    public TMP_Text forestStars, lavaStars, snowStars, desertStars;
    ...
    public GameObject GarageOBJ, LockedOBJ;
    ...
    void Start()
    {
        ...
        string[] grassLevels = new string[3] {"Grass", "Grass2", "Grass3"};
        ...
        totalStars = 0;
        starsTotal = 0;
        string[] desertLevels = new string[1] {"Desert"};
