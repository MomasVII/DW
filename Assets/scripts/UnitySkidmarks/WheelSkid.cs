...
public class WheelSkid : MonoBehaviour {
	...
	const float SKID_FX_SPEED = 1.5f; // Min side slip speed in m/s to start showing a skid
	...
	protected void Awake() {
		skidmarksController = GameObject.FindWithTag("Skidmarks").GetComponent<Skidmarks>();
		wheelCollider = GetComponent<WheelCollider>();
		//driftScoreText = GameObject.FindWithTag("DriftScore").GetComponent<TextMesh>();
	}
